...
# Use picke to serialize the model objects and save a files.
# They can then be loaded and used later.

pickle.dump(IntroExtro, open('intro-extro.pkl', 'wb'))
pickle.dump(SensorIntutive, open('senso-intuit.pkl', 'wb'))
pickle.dump(ThinkerFeeler, open('think-feel.pkl', 'wb'))
pickle.dump(JudgerPerceiver, open('judge-percv.pkl', 'wb'))
